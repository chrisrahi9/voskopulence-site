...
const HERO_VERSION = "20260912-v6-3-adaptive-hls3";
...
if (!source.includes("startLevel: isCompactHero ? -1 : 0")) throw new Error("Desktop 1080p start policy missing");
...
console.log("V6_3_ADAPTIVE_HLS_HERO_PREPARED", {
  ...
  desktopInitialLevel: "1080p",
  desktopMayDowngrade: true,
  mobileInitialLevel: "adaptive",
