...
const HLS_SAFARI_MASTER = "/hero_hls_v6_3/master-safari.m3u8";
const HERO_POSTER = "/hero_web_v6_3_poster.jpg";
const HERO_VERSION = "20260914-v6-3-1440-safari-floor";
...
if (!source.includes(HLS_SAFARI_MASTER)) throw new Error("Safari adaptive HLS source missing");
...
console.log("V6_3_1440_SAFARI_FLOOR_HERO_PREPARED", {
  desktop: "1080p60 direct MP4",
  safariMobile: "1440/1080/900/720 native HLS",
  androidMobile: "1440/1080/900/720/540 hls.js",
  viewportPause: true,
